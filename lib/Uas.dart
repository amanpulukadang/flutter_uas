...
class _HomePageState extends State<HomePage> {
  TextEditingController nameController = TextEditingController(text: 'Supriyatman Pulukadang');
  TextEditingController nimController = TextEditingController(text: '22501059');
  TextEditingController kelasController = TextEditingController(text: '4B' );
